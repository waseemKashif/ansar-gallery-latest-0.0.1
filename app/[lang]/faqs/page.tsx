    ...
    return (
        <PageContainer>
            <div className="flex flex-col lg:grid lg:grid-cols-2 min-h-[400px] items-center justify-center bg-white lg:px-8 px-4 py-12">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2 mt-4">
                        <Link href="https://api.whatsapp.com/send/?phone=97460094446&text=Hi,%20Can%20you%20assist%20me?&app_absent=0" target="_blank" title="Contact Us on WhatsApp" className="flex items-center gap-2 text-primary font-medium hover:underline">
            ...
            <div className=" lg:pb-8 pb-4 max-w-full mx-auto my-4">
                <h2 className="lg:text-xl text-base font-bold text-gray-800 px-4 pb-2">Orders</h2>
            ...
            <div className=" lg:pb-8 pb-4 max-w-full mx-auto">
                <h2 className="lg:text-xl text-base font-bold text-gray-800 px-4 pb-2">Security</h2>
                <Accordion type="single" collapsible className="w-full space-y-4 bg">
            ...
            <div className=" lg:pb-8 pb-4 max-w-full mx-auto">
                <h2 className="lg:text-xl text-base font-bold text-gray-800 px-4 pb-2">Payments</h2>
                <Accordion type="single" collapsible className="w-full space-y-4 bg">
            ...
            <div className=" lg:pb-8 pb-4 max-w-full mx-auto">
                <h2 className="lg:text-xl text-base font-bold text-gray-800 px-4 pb-2">Delivery</h2>
                <Accordion type="single" collapsible className="w-full space-y-4 bg">
            ...
            <div className=" lg:pb-8 pb-4 max-w-full mx-auto">
                <h2 className="lg:text-xl text-base font-bold text-gray-800 px-4 capitalize pb-2">Returns / cancellations warranty</h2>
                <Accordion type="single" collapsible className="w-full space-y-4 bg">
