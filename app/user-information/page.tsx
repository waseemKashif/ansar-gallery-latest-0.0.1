...
// import OrderSummary from "@/components/shared/placeorder-user-information/order-summary";
        ...
        <PageContainer>
            ...
            <div className=" lg:grid flex flex-col lg:grid-cols-2 gap-2 my-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <Label className="text-sm text-gray-600 mb-2 block">Selected Address</Label>
            ...
            <div className="w-full flex justify-center">
                <Button
                    ...
                    disabled={!canProceed}
                    className="w-full mb-4 max-w-lg mx-auto"
                    size="lg"
                >
